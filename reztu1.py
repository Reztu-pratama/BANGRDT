...
poll = LinePoll(cl)
call = cl
creator = ["U2294bd2c801012d5fa257a74dd0d80a7"]
owner = ["U2294bd2c801012d5fa257a74dd0d80a7"]
admin = ["U2294bd2c801012d5fa257a74dd0d80a7"]
staff = ["U2294bd2c801012d5fa257a74dd0d80a7"]
...
wait = {
    ...
    "comment":" ──────┅❇͜͡❇͜͡☆͜͡❇͜͡❇┅──────\nᴼᴾᴱᴺ ᴼᴿᴰᴱᴿ\n────────┅┅───────\n➣ꜱᴇʟꜰʙᴏᴛ ᴏɴʟʏ\n➣ꜱᴇʟꜰʙᴏᴛ + ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 2 ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 3 ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 4 ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 5 ᴀꜱɪꜱᴛ\n➣ʙᴏᴛᴘʀᴏᴛᴇᴄᴛ 3-11 ʙᴏᴛ ᴀꜱɪꜱᴛ\n➣ɴᴇᴡ ꜱᴄʀɪᴘᴛ\n➣ʜʀɢᴀ ʙɪꜱᴀ ɴᴇɢᴏ\n─────────┅┅─────────\n  ✯❇͜͡❇͜͡C͜͡r͜͡e͜͡a͜͡t͜͡o͜͡r✯͜͡$͜͡ë͜͡I͜͡F͜͡-͜͡฿͜͜͡͡o͜͡t͜͡ ͜͡❇͜͡❇✯\line.me/ti/p/BANGRDTBOT➣ѕєʟғвот κɪcκєʀ_+_ᴘʀᴏᴛᴇᴄᴛ\n────────┅❇͜͡❇͜͡☆͜͡❇͜͡❇┅────────",
...
def help():
    ...
    key = key.title()
    helpMessage = "®️❂͜͡➣ " + key + " [ⒹT~ⒷⓄⓣ☯t]\n" + \
                   "®️❂͜͡➣" + key + "✰DRAGON KILLER✰\n" + \
                  "®️❂͜͡➣ " + key + "ʜᴇʟᴘ\n" + \
                  "®️❂͜͡➣ " + key + "ʜᴇʟᴘ1\n" + \
                  "®️❂͜͡➣ " + key + "ʜᴇʟᴘ2\n" + \
                   "®️❂͜͡➣" + key + "ʜᴇʟᴘ3\n" + \
                  ...
                  "®️❂͜͡➣ " + key + "ᴄʀᴇᴀᴛᴏʀ\n" + \
                  "®️❂͜͡➣ " + key + "sᴘᴇᴇᴅ/sᴘ\n" + \
                  "®️❂͜͡➣ " + key + "ᴋɪᴄᴋᴀʟʟᴍᴇᴍʙᴇʀ)\n" + \
                  "®️❂͜͡➣ " + key + "ʙʀᴏᴀᴅᴄᴀsᴛ:「ᴛᴇxᴛ」\n" + \
                  "®️❂͜͡➣ " + key + "sᴇᴛᴋᴇʏ「ɴᴇᴡ ᴋᴇʏ」 \n" + \
                  "®️❂͜͡➣ " + key + "ᴍʏᴋᴇʏ\n" + \
                   "®️❂͜͡➣" + key + "ʀᴇsᴇᴛᴋᴇʏ\n" + \
                  "®️❂͜͡➣ " + key + "ʀᴇғʀᴇsʜ\n" + \
                  "🤵❂͜͡➣ " + key + "Restart\n"+ \
...
def help1():
    ...
    helpMessage1 = "🇲🇨❂͜͡➣ " + key + " [🔰ⒹT~ⒷⓄⓣ☯t]\n" + \
                  ...
                  "🇲🇨❂͜͡➣ " + key + "sᴘᴀᴍᴄᴀʟʟ:「ᴊᴜᴍʟᴀʜɴʏᴀ」\n" + \
                   ...
                   "「🇲🇨]   ʙʏ: BANGRDT「🇲🇨] \n" + \
                   "  Creator:  line.me/ti/p/BANGRDTBOT"
...
def help2():
    ...
    helpMessage2= "      「✭SETTING DT-BOT✭」\n" + \
                  ...
                  " [⚔️DTBOT-LINE]🕸 ⃢   ⟗\n" + \
                  "⚔️Creator:  line.me/ti/p/BANGRDTBOT"
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if msg._from in admin:
                             ...
                             jawab = ("──────┅❇͜͡❇͜͡☆͜͡❇͜͡❇┅──────\nᴼᴾᴱᴺ ᴼᴿᴰᴱᴿ\n────────┅┅───────\n➣ꜱᴇʟꜰʙᴏᴛ ᴏɴʟʏ\n➣ꜱᴇʟꜰʙᴏᴛ + ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 2 ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 3 ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 4 ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 5 ᴀꜱɪꜱᴛ\n➣ʙᴏᴛᴘʀᴏᴛᴇᴄᴛ 3-11 ʙᴏᴛ ᴀꜱɪꜱᴛ\n➣ɴᴇᴡ ꜱᴄʀɪᴘᴛ\n➣ʜʀɢᴀ ʙɪꜱᴀ ɴᴇɢᴏ\n─────────┅┅─────────\n  ✯❇͜͡❇͜͡C͜͡r͜͡e͜͡a͜͡t͜͡o͜͡r✯͜͡$͜͡ë͜͡I͜͡F͜͡-͜͡฿͜͜͡͡o͜͡t͜͡ ͜͡❇͜͡❇✯\line.me/ti/p/BANGRDTBOT\n➣ѕєʟғвот κɪcκєʀ_+_ᴘʀᴏᴛᴇᴄᴛ\n────────┅❇͜͡❇͜͡☆͜͡❇͜͡❇┅────────")
