...
cl = LineClient(authToken='EHNFQuIdhsM2VAWKMM12.7Azc5pz+SlomGgGvh3Q18G.YHRjHyMflWodWrl1ImbO+Kwn9h5fdUhmtYSHLiRX87M=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))
print("\n📶 BOT R.D'TOLA MULAI BEKERJA...... \n")
...
wait = {
    ...
    "comment":" ──────┅❇͜͡❇͜͡☆͜͡❇͜͡❇┅──────\nᴼᴾᴱᴺ ᴼᴿᴰᴱᴿ\n────────┅┅───────\n➣ꜱᴇʟꜰʙᴏᴛ ᴏɴʟʏ\n➣ꜱᴇʟꜰʙᴏᴛ + ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 2 ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 3 ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 4 ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 5 ᴀꜱɪꜱᴛ\n➣ʙᴏᴛᴘʀᴏᴛᴇᴄᴛ 3-11 ʙᴏᴛ ᴀꜱɪꜱᴛ\n➣ɴᴇᴡ ꜱᴄʀɪᴘᴛ\n➣ʜʀɢᴀ ʙɪꜱᴀ ɴᴇɢᴏ\n─────────┅┅─────────\n  ✯❇͜͡❇͜͡C͜͡r͜͡e͜͡a͜͡t͜͡o͜͡r✯͜͡$͜͡ë͜͡I͜͡F͜͡-͜͡฿͜͜͡͡o͜͡t͜͡ ͜͡❇͜͡❇✯https://line.me/ti/p/BANGRDTBOT➣ѕєʟғвот κɪcκєʀ_+_ᴘʀᴏᴛᴇᴄᴛ\n────────┅❇͜͡❇͜͡☆͜͡❇͜͡❇┅────────",
...
def help():
    ...
    helpMessage = "🛡️༒" + key + " [RDTBOT]\n" + \
                  ...
                  "🛡️༒" + key + "ʀᴇғʀᴇsʜ\n" + \
                  "🛡️༒" + key + "Restart\n"+ \
                  "🛡️༒[[RDTBOT]] Creator:  https://line.me/ti/p/reztu_pratama"
...
def help1():
    ...
    helpMessage1 = "🇲🇨❂͜͡➣ " + key + " [🇲🇨ⒹT~ⒷⓄⓣ☯t]\n" + \
                  ...
                  "🇲🇨⚔️❂͜͡➣ " + key + "Dkbot\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "Harga\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "Adminadd @\Admindell @\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "Staffadd @\Staffdell @「ɴᴏᴍᴇʀ」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "Bot:on\off\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "Refresh\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "Botrefeat @\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "Promo\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "ɪɴғᴏɢʀᴜᴘ「ɴᴏᴍᴇʀ」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "ɪɴғᴏᴍᴇᴍ「ɴᴏᴍᴇʀ」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "ʀᴇᴍᴏᴠᴇ ᴄʜᴀᴛ\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "ᴍɪᴅ「@」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "sᴛᴇᴀʟ「@」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "ᴄᴏᴠᴇʀ「@」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "ᴄʟᴏɴᴇ「@」\n" + \
                  ...
                  "🇲🇨⚔️❂͜͡➣ " + key + "ʙᴀᴄᴋᴜᴘ\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "ʀᴇᴊᴇᴄᴛ\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "sᴘᴀᴍᴄᴀʟʟᴛᴏ 「ᴊᴜᴍʟᴀʜ」 「@」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "sᴘᴀᴍᴛᴀɢ:「ᴊᴜᴍʟᴀʜɴʏᴀ」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "sᴘᴀᴍᴛᴀɢ「@」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "sᴘᴀᴍᴄᴀʟʟ:「ᴊᴜᴍʟᴀʜɴʏᴀ」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "sᴘᴀᴍᴄᴀʟʟ\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "ᴍʏɴᴀᴍᴇ:「ɴᴀᴍᴀ」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "ᴄᴘᴘ「ᴋɪʀɪᴍ ғᴏᴛᴏɴʏᴀ」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "ᴄᴠᴘ 「ᴋɪʀɪᴍ ᴠɪᴅᴇᴏɴʏᴀ」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "ᴜᴘᴅᴀᴛᴇɢʀᴜᴘ\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "ɢɪғᴛ:「ᴍɪᴅ ᴋᴏʀʙᴀɴ」「ᴊᴜᴍʟᴀʜ」\n" + \
                  "🇲🇨⚔️❂͜͡➣ " + key + "sᴘᴀᴍ:「ᴍɪᴅ ᴋᴏʀʙᴀɴ」「ᴊᴜᴍʟᴀʜ」\n" + \
                  "「🤵]   ʙʏ: [[RDTBOT]]「🤵] \n" + \
                  "  Creator:  https://line.me/ti/p/reztu_pratama "
...
def help2():
    ...
    helpMessage2= "      「✭SETTING DTBOT✭」\n" + \
                  ...
                  "「®️📶」"[[RDTBOT]]\n" + \
                  "「®️📶 Creator:  https://line.me/ti/p/reztu_pratama"
    ...
    try:
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  cl.sendContact(op.param1, "ueda642e4f67fb0b38c8068151f7ab5f2")
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                ryan = cl.getContact(msg_dict[msg_id]["from"])
                                ret_ =  "「 ᴘᴇsᴀɴ ᴅɪʜᴀᴘᴜs  」\n"
                                ret_ += "「🐲®️」 ᴘᴇɴɢɪʀɪᴍ : {}".format(str(ryan.displayName))
                                ret_ += "\n「🐲®️」ɴᴀᴍᴀ ɢʀᴜᴘ : {}".format(str(ginfo.name))
                                ret_ += "\n「🐲®️」ᴡᴀᴋᴛᴜ ɴɢɪʀɪᴍ: {}".format(dt_to_str(cTime_to_datetime(msg_dict[msg_id]["createdTime"])))
                ...
                try:
                    ...
                    if msg_id in msg_dict1:
                        if msg_dict1[msg_id]["from"]:
                                ...
                                ret_ += "「🐲®️」➣ ᴘᴇɴɢɪʀɪᴍ : {}".format(str(ryan.displayName))
                                ret_ += "\n•「🐲®️」 ɴᴀᴍᴀ ɢʀᴜᴘ : {}".format(str(ginfo.name))
                                ret_ += "\n•「🐲®️」 ᴡᴀᴋᴛᴜ ɴɢɪʀɪᴍ : {}".format(dt_to_str(cTime_to_datetime(msg_dict1[msg_id]["createdTime"])))
                                ret_ += "\n⟗「🐲®️」 DT-BOT🕸 ⃢   ⟗"
                                ret_ += "\nCreator: https://line.me/ti/p/reztu_pratama" 
                           ...
                           if targets == []:
                               ...
                               for target in targets:
                                   try:
                                       ...
                                       cl.createGroup("©️ELU DISPAM GOBLOK",[target]) 
                                       cl.createGroup("©️ELU DISPAM GOBLOK",[target]) 
                                       cl.createGroup("©️ELU DISPAM GOBLOK",[target])
               ...
               if msg.contentType == 16:
                    if wait["Timeline"] == True:
                            ...
                            if "text" in msg.contentMetadata:
                                text = "\n• 「🛡️®️」Tulisan : {}".format(str(msg.contentMetadata["text"]))
                                purl = "\n• 「🛡️®️」Post URL : {}".format(str(msg.contentMetadata["postEndUrl"]).replace("line://","https://line.me/R/"))
                                ret_ += purl
                                ret_ += text
                  ...
                  if wait["invite"] == True:
                    ...
                    for s in groups.members:
                        if invite in wait["blacklist"]:
                            cl.sendMessage(msg.to, "「🕵️Dia ke bl kak... hpus bl dulu lalu invite lagi」")
                            break
                        else:
                            targets.append(invite)
                    if targets == []:
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                bot = runtime(eltime)
                                start = time.time()
                                #cl.sendText("ueda642e4f67fb0b38c8068151f7ab5f2", '.')
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if msg._from in admin:
