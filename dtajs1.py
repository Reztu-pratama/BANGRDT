...
poll = LinePoll(cl)
call = cl
creator = ["ueda642e4f67fb0b38c8068151f7ab5f2"]
owner = ["ueda642e4f67fb0b38c8068151f7ab5f2"]
admin = ["ueda642e4f67fb0b38c8068151f7ab5f2"]
staff = ["ueda642e4f67fb0b38c8068151f7ab5f2"]
...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"SINI KAK BERGABUNG SEMOGA BETAH👉🇲🇨",
    "Respontag":"SEKARANG TAG BESOK JATUH CINTA💘",
    "welcome":"Selamat datang & semoga betah di dini",
    "comment":"jangan lupa like, comen dan di subscribe channel BANG RDT",
    "message":"Terimakasih sayang udh add saya😜",
    }
...
def help():
    ...
    helpMessage = "✡️MENU HELP✡️\n" + \
                  ...
                  "®️🕵️" + key + "Byeall\n" + \
                  "®️🕵️" + key + "Byeme\n" + \
                  "®️🕵️" + key + "Leave「Namagrup」\n" + \
                  "®️🕵️" + key + "Ginfo\n" + \
                  "®️🕵️" + key + "Open\n" + \
                  "®️🕵️" + key + "Close\n" + \
                  "®️🕵️" + key + "Url grup\n" + \
                  "®️🕵️" + key + "Gruplist\n" + \
                  "®️🕵️" + key + "Infogrup「angka」\n" + \
                  "®️🕵️" + key + "Infomem「angka」\n" + \
                  "®️🕵️" + key + "Remove chat\n" + \
                  "®️🕵️" + key + "Lurking「on/off」\n" + \
                  "®️🕵️" + key + "Lurkers\n" + \
                  "®️🕵️" + key + "Sider「on/off」\n" + \
                  "®️🕵️" + key + "Updatefoto\n" + \
                  "®️🕵️" + key + "Updategrup\n" + \
                  "®️🕵️" + key + "Updatebot\n" + \
                  "®️🕵️" + key + "Broadcast:「Text」\n" + \
                  "®️🕵️" + key + "Setkey「New Key」\n" + \
                  "®️🕵️" + key + "Mykey\n" + \
                  "®️🕵️" + key + "Resetkey\n" + \
                  "®️🕵️" + key + "ID line:「Id Line nya」\n" + \
                  "®️🕵️" + key + "Sholat:「Nama Kota」\n" + \
                  "®️🕵️" + key + "Cuaca:「Nama Kota」\n" + \
                  "®️🕵️" + key + "Lokasi:「Nama Kota」\n" + \
                  "®️🕵️" + key + "Music:「Judul Lagu」\n" + \
                  "®️🕵️" + key + "Lirik:「Judul Lagu」\n" + \
                  "®️🕵️" + key + "Ytmp3:「Judul Lagu」\n" + \
                  "®️🕵️" + key + "Ytmp4:「Judul Video」\n" + \
                  "®️🕵️" + key + "Profileig:「Nama IG」\n" + \
                  "®️🕵️" + key + "Cekdate:「tgl-bln-thn」\n" + \
                  "®️🕵️" + key + "Jumlah:「angka」\n" + \
                  "®️🕵️" + key + "Spamtag「@」\n" + \
                  "®️🕵️" + key + "Spamcall:「jumlahnya」\n" + \
                  "®️🕵️" + key + "Spamcall\n" + \
                  "®️🕵️" + key + "Notag「on/off」\n" + \
                  "®️🕵️" + key + "Allpro「on/off」\n" + \
                  "®️🕵️" + key + "Protecturl「on/off」\n" + \
                  "®️🕵️" + key + "Protectjoin「on/off」\n" + \
                  "®️🕵️" + key + "Protectkick「on/off」\n" + \
                  "®️🕵️" + key + "Protectcancel「on/off」\n" + \
                  "®️🕵️" + key + "Antijs「on/off」\n" + \
                  "®️🕵️" + key + "Antijs stay\n" + \
                  "®️🕵️" + key + "Ghost「on/off」\n" + \
                  "®️🕵️" + key + "Sticker「on/off」\n" + \
                  "®️🕵️" + key + "Respon「on/off」\n" + \
                  "®️🕵️" + key + "Contact「on/off」\n" + \
                  "®️🕵️" + key + "Autojoin「on/off」\n" + \
                  "®️🕵️" + key + "Autoadd「on/off」\n" + \
                  "®️🕵️" + key + "Welcome「on/off」\n" + \
                  "®️🕵️" + key + "Autoleave「on/off」\n" + \
                  "®️🕵️" + key + "Admin:on\n" + \
                  "®️🕵️" + key + "Admin:repeat\n" + \
                  "®️🕵️" + key + "Staff:on\n" + \
                  "®️🕵️" + key + "Staff:repeat\n" + \
                  "®️🕵️" + key + "Bot:on\n" + \
                  "®️🕵️" + key + "Bot:repeat\n" + \
                  "®️🕵️" + key + "Adminadd「@」\n" + \
                  "®️🕵️" + key + "Admindell「@」\n" + \
            ...
            if mid in op.param3:
                if wait["autoLeave"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        cl.sendMessage(op.param1,"Selamat Tinggal Sobat\n Group " +str(ginfo.name))
               ...
               if msg.contentType == 13:
                 if wait["contact"] == True:
                    ...
                    if 'displayName' in msg.contentMetadata:
                        ...
                        cl.sendMessage(msg.to,"®️Nama : " + msg.contentMetadata["displayName"] + "\n®️MID : " + msg.contentMetadata["mid"] + "\n®️Status Msg : " + contact.statusMessage + "\n®️Picture URL : http://dl.profile.line-cdn.net/" + contact.pictureStatus)
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator Bot BANGRDTBOT") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "®️DTBOT Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
                          ...
                          if msg._from in admin:
                            if msg.to in Setmain['ARreadPoint']:
                                if Setmain['ARreadMember'][msg.to] != {}:
                                    ...
                                    cl.sendText(msg.to, "User RDTBOT...")
                            else:
...
#===========Hiburan============#
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                for s in stream:
                                    ...
                                    author = '\n\n®️Author : ' + str(vid.author)
                                    durasi = '\n®️Duration : ' + str(vid.duration)
                                    suka = '\n®️Likes : ' + str(vid.likes)
                                    rating = '\n®️Rating : ' + str(vid.rating)
                                    deskripsi = '\n®️Deskripsi : ' + str(vid.description)
                          ...
                          if msg._from in admin:
                            ...
                            cl.sendMessage(msg.to,"®️I N F O R M A S I ®️\n\n"+"®️Date Of Birth : "+lahir+"\n®️Age : "+usia+"\n®️Ultah : "+ultah+"\n®️Zodiak : "+zodiak)
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"®️DTBOT Blacklist User\n\n"+ma+"\nTotal「%s」Blacklist User" %(str(len(wait["blacklist"]))))
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"®️DTBOT Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
